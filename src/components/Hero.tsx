          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 max-w-2xl">
                ...
                Join developers across Italy who are passionate about Cursor and AI-powered development.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-semibold text-gray-900">{memberCount}+ Members</span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="font-semibold text-gray-900">Monthly Events</span>
              </div>
            </div>
              ...
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-medium text-sm text-gray-900">Live Community</span>
                  </div>
                </div>
              </div>
