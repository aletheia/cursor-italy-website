...
import { Shield, Users, MessageCircle, AlertTriangle, Mail } from 'lucide-react';
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Creating a safe, welcoming, and productive environment for all members of our community
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600 text-sm">
                Everyone is welcome regardless of background, experience level, or identity
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600 text-sm">
                Zero tolerance for harassment, discrimination, or harmful behavior
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto container-padding">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-red-700 text-sm">
                    If you are in immediate danger or experiencing harassment at an event, please:
                  </p>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    <div className="text-blue-700 text-sm">
                      Email: <span className="font-mono bg-blue-100 px-2 py-1 rounded">organizers@cursor-italy.dev</span>
                    </div>
                    <div className="text-blue-700 text-sm">
                      Anonymous form: <Link href="#" className="underline">Report Anonymously</Link>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 bg-gray-50 rounded-2xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <h4 className="font-medium text-gray-900 mb-2">Helpful (if available):</h4>
                <ul className="space-y-1 text-gray-600 text-sm">
          ...
          <div className="space-y-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">We will acknowledge receipt of your report within 24 hours.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Investigation</h3>
                <p className="text-gray-600">We will investigate all reports fairly, confidentially, and thoroughly.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Appropriate action will be taken based on our findings and the severity of the issue.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">We will follow up with the reporter on the outcome and any actions taken.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto container-padding text-center">
          <div className="space-y-8">
            ...
            <div className="text-sm text-gray-500 max-w-2xl mx-auto">
              This Code of Conduct is a living document that may be updated as our community grows and evolves. 
              All community members will be notified of any significant changes.
            </div>
          </div>
        </div>
      </section>
