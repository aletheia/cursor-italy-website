...
export const metadata: Metadata = {
  title: 'Contact Us',
  description:
    "Get in touch with the Cursor Italy organizers. We'd love to hear from you!",
};
          ...
          <div className='text-center space-y-8'>
            <div className='space-y-4'>
              ...
              <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                Have questions, suggestions, or want to get involved? We'd love
                to hear from you!
              </p>
            </div>
          </div>
            ...
            <div className='space-y-8'>
              <div>
                ...
                <p className='text-lg text-gray-600 mb-8'>
                  Whether you want to speak at an event, become a sponsor, or
                  just say hello, we're here to help!
                </p>
              </div>
              ...
              <div className='space-y-6'>
                ...
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-500'>
                      Events typically held in Milano
                    </p>
                  </div>
                </div>
          ...
          <div className='space-y-6'>
            <div className='bg-white rounded-xl p-6 shadow-sm'>
              <h3 className='font-semibold text-gray-900 mb-2'>
                How can I speak at an event?
              </h3>
              <p className='text-gray-600'>
                We welcome speakers of all levels! Submit your proposal through
                our Sessionize page or reach out to us directly. We're
                particularly interested in AI development, Cursor tips, and
                related topics.
              </p>
            </div>
            ...
            <div className='bg-white rounded-xl p-6 shadow-sm'>
              ...
              <p className='text-gray-600'>
                We offer various sponsorship opportunities. Contact us via email
                or LinkedIn to discuss how your organization can support our
                community and get exposure to our talented developer community.
              </p>
            </div>
            ...
            <div className='bg-white rounded-xl p-6 shadow-sm'>
              ...
              <p className='text-gray-600'>
                Our events are typically held in Milano, Italy. We partner with
                local tech companies and coworking spaces to provide great
                venues for our meetups.
              </p>
            </div>
            ...
            <div className='bg-white rounded-xl p-6 shadow-sm'>
              ...
              <p className='text-gray-600'>
                Join our Meetup group to get notified about upcoming events,
                follow us on LinkedIn for news and updates, or check our website
