...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Luca Bianchi, founder of Cursor Italy and Cursor Ambassador, his vision, and journey in building Italy's AI development community.",
};
            ...
            <div className='space-y-8'>
              <div className='space-y-4'>
                ...
                <p className='text-xl text-gray-600'>
                  Founder of Cursor Italy, Cursor Ambassador, and passionate
                  advocate for AI-powered development in Italy.
                </p>
              </div>
        ...
        <div className='max-w-7xl mx-auto container-padding'>
          <div className='text-center mb-16'>
            ...
            <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
              Luca's contributions to the Italian tech community and AI
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            ...
            <div className='bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center'>
              ...
              <p className='text-gray-600 text-sm mb-4'>
                Founded Cursor Italy and built a thriving community of 14+
                passionate developers in Milano
              </p>
            ...
            <div className='bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center'>
              ...
              <p className='text-gray-600 text-sm mb-4'>
                Regular speaker on AI development, product specification, and
                community building
              </p>
            ...
            <div className='bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center'>
              ...
              <p className='text-gray-600 text-sm mb-4'>
                Official representative of Cursor in Italy, promoting AI-powered
                development tools
              </p>
            ...
            <div className='space-y-6'>
              <div>
                ...
                <p className='text-lg text-gray-600 mb-6'>
                  Luca envisions an Italy where every developer has access to
                  cutting-edge AI tools and a supportive community to accelerate
              ...
              <div className='space-y-4'>
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 text-sm'>
                      Make advanced AI development tools accessible to
                      developers across Italy, regardless of their background or
                      experience level.
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 text-sm'>
                      Create an environment where developers can experiment,
                      learn, and build innovative solutions using AI-powered
                      tools.
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 text-sm'>
                      Connect passionate developers across Italy to share
                      knowledge, collaborate on projects, and grow together.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className='space-y-6'>
                  ...
                  <div>
                    ...
                    <p className='text-white/90 text-sm'>
                      "We're not just learning to use AI tools—we're building
                      the future of development itself."
                    </p>
                  </div>
          ...
          <div className='space-y-8'>
            <div>
              ...
              <p className='text-lg text-gray-600'>
                Be part of the movement that's shaping the future of AI
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <div className='bg-white rounded-2xl shadow-sm border border-gray-200 p-6'>
                <div className='space-y-4'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Connect with fellow developers, attend events, and be part
              ...
              <div className='bg-white rounded-2xl shadow-sm border border-gray-200 p-6'>
                <div className='space-y-4'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Share your expertise and contribute to the community through
                    our open CFP system.
                  </p>
                  <Link
