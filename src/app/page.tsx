...
export const metadata: Metadata = {
  ...
  description:
    "Join Italy's premier community for AI-powered development with Cursor. Monthly meetups, workshops, and networking in Milano.",
};
...
export default async function HomePage() {
  ...
  return (
    <div className='min-h-screen'>
        ...
        <section className='section-padding bg-gray-50'>
          <div className='max-w-7xl mx-auto container-padding'>
            <div className='flex items-center justify-between mb-12'>
              ...
              <Link href='/events' className='btn btn-secondary hidden sm:flex'>
                All Events
      ...
      {/* Sponsors Section */}
      {sponsors.length > 0 && (
        <SponsorGrid sponsors={sponsors} title='Our Amazing Sponsors' />
      )}
